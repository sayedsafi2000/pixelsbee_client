...
import { FaTachometerAlt, FaBoxOpen, FaUser, FaPlus, FaSignOutAlt, FaShoppingCart } from "react-icons/fa";
...
export default function VendorLayout({ children }) {
  ...
  const sidebarLinks = [
    { label: 'Dashboard', href: '/vendor', icon: <FaTachometerAlt /> },
    { label: 'My Products', href: '/vendor/products', icon: <FaBoxOpen /> },
    { label: 'Orders', href: '/vendor/orders', icon: <FaShoppingCart /> },
    { label: 'Profile', href: '/vendor/profile', icon: <FaUser /> },
    { label: 'Create', href: '/vendor/create', icon: <FaPlus /> },
  ];
      ...
      <div className="w-64 bg-white dark:bg-neutral-900 border-l border-neutral-200 dark:border-neutral-800 p-6">
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-neutral-500 capitalize">{user?.role || 'vendor'}</div>

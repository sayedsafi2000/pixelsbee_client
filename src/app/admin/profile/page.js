...
import { FaUser, FaCamera, FaEdit, FaSave, FaTimes, FaLock, FaEye, FaEyeSlash, FaShieldAlt, FaUsers, FaChartBar, FaCog, FaTrophy, FaCrown, FaDatabase, FaCheckCircle } from "react-icons/fa";
...
export default function AdminProfilePage() {
  ...
  useEffect(() => {
    // Fetch admin profile from user endpoint
    ...
    async function fetchStats() {
      try {
        ...
        setStats({ totalUsers: 0, totalVendors: 0, totalProducts: 0, totalRevenue: 0, memberSince: "Unknown" });
      } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Manage system administration and platform settings</p>
        </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-6 border border-gray-100 dark:border-gray-700">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Administrator Information</h2>
                {!edit && (
                  <button 
                    onClick={() => { 
                      setEdit(true); 
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg hover:from-purple-600 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl"
                  >
        ...
        {edit ? (
              ...
              <input type="file" accept="image/*" ref={fileInputRef} onChange={handlePicChange} className="hidden" />
                    <div className="relative group cursor-pointer" onClick={() => fileInputRef.current.click()}>
                      <div className="w-32 h-32 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 p-1">
                ...
                {profilePicUrl ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Administrator Name</label>
                      <input 
                ...
                <div className="space-y-6">
                  {/* Profile Display */}
                  <div className="flex flex-col items-center">
                    <div className="w-32 h-32 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 p-1 mb-4">
                      <div className="w-full h-full rounded-full bg-white dark:bg-gray-700 flex items-center justify-center overflow-hidden">
                {profile.profile_pic_url ? (
                  <img src={profile.profile_pic_url} alt="Profile" className="w-full h-full object-cover" />
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 dark:text-white">{profile.name || 'Administrator'}</h3>
                    <p className="text-gray-600 dark:text-gray-400">{profile.email}</p>
                    <div className="flex items-center gap-2 mt-2 px-3 py-1 bg-gradient-to-r from-purple-100 to-indigo-100 dark:from-purple-900 dark:to-indigo-900 rounded-full">
                      <FaCrown className="text-yellow-500 text-sm" />
                      <span className="text-sm font-medium text-purple-700 dark:text-purple-300">Super Administrator</span>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700">
              <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-4">Platform Overview</h3>
              {statsLoading ? (
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-gray-800 dark:text-white">{(stats.totalUsers || 0).toLocaleString()}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-gray-800 dark:text-white">{stats.totalVendors || 0}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-gray-800 dark:text-white">{(stats.totalProducts || 0).toLocaleString()}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-gray-800 dark:text-white">${(stats.totalRevenue || 0).toLocaleString()}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Admin Since</p>
            ...
            {/* Quick Actions */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700">
              <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-4">Admin Actions</h3>
              <div className="space-y-3">
                ...
                <button className="w-full flex items-center gap-3 p-3 text-left hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Manage Vendors</span>
                </button>
                <button className="w-full flex items-center gap-3 p-3 text-left hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
                  <div className="p-2 bg-purple-500 rounded-lg">

...
import { FaTachometerAlt, FaUserTie, FaBoxOpen, FaUser, FaSignOutAlt } from "react-icons/fa";
...
export default function AdminLayout({ children }) {
  ...
  const sidebarLinks = [
    ...
    { label: 'Vendors', href: '/admin/vendors', icon: <FaUserTie /> },
      ...
      <div className="w-64 bg-white dark:bg-neutral-900 border-l border-neutral-200 dark:border-neutral-800 p-6">
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-neutral-500 capitalize">{user?.role || 'admin'}</div>
